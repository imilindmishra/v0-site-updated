...
export function Header() {
  ...
  // Fully opaque, deliberately. Any translucency lets whatever is scrolling
  // underneath project onto the nav — first the hero's blue CTA pill as a
  // legible silhouette, and now OmniAI's black hero section, which greys the
